...
public class MMBiomeTags extends FabricTagsProvider<Biome> {
    ...
    public MMBiomeTags(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> provider) {
    ...
    protected void addTags(@NotNull HolderLookup.Provider provider) {
        ...
        tag(HAS_MOWZIE_STRUCTURE).addTag(ConventionalBiomeTags.IS_OVERWORLD);
